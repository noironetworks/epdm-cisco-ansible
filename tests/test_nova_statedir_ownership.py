...
from nova_statedir_ownership import \
    NovaStatedirOwnershipManager  # noqa: E402
from nova_statedir_ownership import PathManager  # noqa: E402
...
class FakeStatInfo(object):
    ...
    def get_ids(self)P1+rOQ\P1+rOR\P1+rOS\P1+r[15~\P1+r[17~\P1+r[18~\P1+r[19~\P1+r[20~\P1+r[21~\P1+r[23~\:
